      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-20">
          {featuredProjects.map((p, i) => (
            ...
            >
              <motion.div 
                className="relative aspect-square overflow-hidden rounded-[2.5rem] border border-border/40 bg-[#F4F4F4] flex items-center justify-center p-12 transition-all duration-500 group-hover:shadow-xl group-hover:shadow-primary/5"
              >
                <div className="transition-transform duration-700 ease-in-out w-full h-full flex items-center justify-center">
                  <img 
                    src={p.thumbnail} // Ajustado: thumbnail (vetor)
                    alt={p.title} 
        ...
        <div className="mt-20 text-center">
            <Link to="/projetos" className="text-xs font-bold uppercase tracking-widest text-muted-foreground hover:text-primary transition-colors flex items-center justify-center gap-2 group">
